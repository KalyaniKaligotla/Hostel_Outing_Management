                ...
                <div class="col-md-4">
                    ...
                    if (isset($_POST["email"]) && isset($_POST["action"]) && ($_POST["action"] == "update")) {
                        ...
                        if ($error != "") {
                            ...
                            $result1 = mysqli_query($conn,"select regno from student_details where email='".$email."'");
                            $row1 = mysqli_fetch_array($result1);
                            $reg = $row1['regno'];
                            $pass1 = md5($pass1);
                            mysqli_query($conn, "UPDATE `login_table` SET `password` = '" . $pass1 . "' WHERE `username` = '$reg'");
